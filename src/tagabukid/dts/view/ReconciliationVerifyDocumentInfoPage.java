...
public class ReconciliationVerifyDocumentInfoPage extends javax.swing.JPanel {

    /**
     * Creates new form DocumentRedFlag
     */
    public ReconciliationVerifyDocumentInfoPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xActionTextField2.setCaption("Search Barcode");
        xActionTextField2.setHint("Search DIN");
        xActionTextField2.setName("din"); // NOI18N
        xActionTextField2.setPreferredSize(new java.awt.Dimension(200, 20));
        xFormPanel3.add(xActionTextField2);
        ...
        xLabel8.setCaption("Document Description");
        xLabel8.setExpression("#{entity.description}");
        xLabel8.setOpaque(true);
        xLabel8.setPreferredSize(new java.awt.Dimension(300, 30));
